  ...
  return (
    <div className="footer">
      <div className="footer__info">
        <div>
          <p className="footer__infoHeading"> ABOUT </p> <p> Contact Us </p>{" "}
          <p> About Us </p> <p> Careers </p> <p> Flipkart Stories </p>{" "}
          <p> Posts </p> <p> Flipkart Wholesale </p>{" "}
          <p> Corporate Information </p>{" "}
        </div>{" "}
        <div>
          <p className="footer__infoHeading"> HELP </p> <p> Payments </p>{" "}
          <p> Shipping </p> <p> Cancellations And Returns </p> <p> FAQ </p>{" "}
          <p> Report Infringment </p>{" "}
        </div>{" "}
        <div>
          <p className="footer__infoHeading"> POLICY </p> <p> Return Policy </p>{" "}
          <p> Terms Of Use </p> <p> Security </p> <p> Privacy </p>{" "}
          <p> Site Map </p> <p> EPR Compliance </p>{" "}
        </div>{" "}
        <div>
          <p className="footer__infoHeading"> SOCIAL </p> <p> Facebook </p>{" "}
          <p> Twitter </p> <p> Youtube </p>{" "}
        </div>{" "}
      ...
      <div className="footer__payment">
        ...
        <p className="copyRight"> & copy; 2007 - 2022 Flipkart.com </p>{" "}
        <img
